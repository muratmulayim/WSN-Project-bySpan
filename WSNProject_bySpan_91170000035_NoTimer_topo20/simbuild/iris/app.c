...
typedef TMilli WSNProject_bySpanC$Timer0$precision_tag;
...
static void WSNProject_bySpanC$Timer0$fired(void );
# 92 "C:/cygwin/opt/tinyos-2.x/tos/interfaces/SplitControl.nc"
static void WSNProject_bySpanC$AMControl$startDone(error_t error);
#line 117
static void WSNProject_bySpanC$AMControl$stopDone(error_t error);
# 49 "C:/cygwin/opt/tinyos-2.x/tos/interfaces/Boot.nc"
static void WSNProject_bySpanC$Boot$booted(void );
# 99 "C:/cygwin/opt/tinyos-2.x/tos/interfaces/AMSend.nc"
static void WSNProject_bySpanC$AMSend$sendDone(
#line 92
message_t * msg, 
...
WSNProject_bySpanC$Receive$receive(
#line 60
message_t * msg, 
void * payload, 
...
uint8_t len);
# 64 "C:/cygwin/opt/tinyos-2.x/tos/interfaces/TaskBasic.nc"
static void WSNProject_bySpanC$printStep$runTask(void );
...
# 69 "C:/cygwin/opt/tinyos-2.x/tos/interfaces/AMSend.nc"
static error_t /*WSNProject_bySpanAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMSend$send(am_addr_t addr, 
#line 60
message_t * msg, 
...
static void /*WSNProject_bySpanAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$Send$sendDone(
#line 85
message_t * msg, 
...
# 62 "C:/cygwin/opt/tinyos-2.x/tos/lib/timer/Timer.nc"
static void WSNProject_bySpanC$Timer0$startOneShot(uint32_t dt);
# 83 "C:/cygwin/opt/tinyos-2.x/tos/interfaces/SplitControl.nc"
static error_t WSNProject_bySpanC$AMControl$start(void );
...
WSNProject_bySpanC$Packet$getPayload(
#line 110
message_t * msg, 
...
uint8_t len);
# 69 "C:/cygwin/opt/tinyos-2.x/tos/interfaces/AMSend.nc"
static error_t WSNProject_bySpanC$AMSend$send(am_addr_t addr, 
#line 60
message_t * msg, 
...
uint8_t len);
# 41 "C:/cygwin/opt/tinyos-2.x/tos/interfaces/Random.nc"
static uint16_t WSNProject_bySpanC$Random$rand16(void );
# 56 "C:/cygwin/opt/tinyos-2.x/tos/interfaces/TaskBasic.nc"
static error_t WSNProject_bySpanC$printStep$postTask(void );
# 77 "C:/cygwin/opt/tinyos-2.x/tos/interfaces/AMPacket.nc"
static am_addr_t WSNProject_bySpanC$AMPacket$source(
#line 73
message_t * amsg);
# 246 "WSNProject_bySpanC.nc"
enum WSNProject_bySpanC$__nesc_unnamed4315 {
#line 246
  WSNProject_bySpanC$printStep = 0U
};
#line 246
typedef int WSNProject_bySpanC$__nesc_sillytask_printStep[WSNProject_bySpanC$printStep];
#line 19
am_addr_t WSNProject_bySpanC$neighborNodes[1000][25];
am_addr_t WSNProject_bySpanC$whiteNodes[1000][25];
am_addr_t WSNProject_bySpanC$grayNodes[1000][25];
am_addr_t WSNProject_bySpanC$blackNodes[1000][25];
am_addr_t WSNProject_bySpanC$spans[1000][25];

uint8_t WSNProject_bySpanC$currentState[1000];
uint8_t WSNProject_bySpanC$myColor[1000];
message_t WSNProject_bySpanC$pkt[1000];

static inline uint8_t WSNProject_bySpanC$generateRandom(uint32_t upperBound);
...
static inline uint8_t WSNProject_bySpanC$sizeofArray(am_addr_t *array);
...
static char *WSNProject_bySpanC$messageTypeToString(uint8_t type);
#line 65
static void WSNProject_bySpanC$sendBroadcastMessage(uint8_t type);
#line 84
static inline void WSNProject_bySpanC$printArray(char *arrName, am_addr_t arr[]);
...
static inline void WSNProject_bySpanC$printFullArray(char *arrName, am_addr_t arr[]);
#line 108
static inline void WSNProject_bySpanC$insertionSort(am_addr_t arr[]);
#line 129
static void WSNProject_bySpanC$deleteElement(am_addr_t arr[], am_addr_t val);
#line 151
static void WSNProject_bySpanC$addElement(am_addr_t arr[], am_addr_t val);
#line 179
static inline uint8_t WSNProject_bySpanC$indexOf(am_addr_t nodeid);



static inline void WSNProject_bySpanC$decreaseSpans(void );
...
static inline void WSNProject_bySpanC$setZeroSpan(am_addr_t nodeid);
#line 207
static inline uint8_t WSNProject_bySpanC$findIndexOfMaximumSpan(am_addr_t arr[]);
#line 221
static void WSNProject_bySpanC$checkIfBlack(void );
#line 246
static inline void WSNProject_bySpanC$printStep$runTask(void );
#line 276
static inline bool WSNProject_bySpanC$isNodeGray(am_addr_t id);
#line 289
static inline bool WSNProject_bySpanC$isNodeBlack(am_addr_t id);
#line 304
static inline void WSNProject_bySpanC$Boot$booted(void );
#line 340
static inline void WSNProject_bySpanC$AMControl$startDone(error_t err);
...
static inline void WSNProject_bySpanC$AMControl$stopDone(error_t err);





static inline void WSNProject_bySpanC$Timer0$fired(void );
#line 369
static void WSNProject_bySpanC$AMSend$sendDone(message_t *msg, error_t err);
#line 396
static inline message_t *WSNProject_bySpanC$Receive$receive(message_t *msg, void *payload, uint8_t len);
# 44 "C:/cygwin/opt/tinyos-2.x/tos/chips/atm128/timer/HplAtm128TimerCtrl8.nc"
...
static am_addr_t ActiveMessageAddressC$amAddress(void );
# 99 "C:/cygwin/opt/tinyos-2.x/tos/interfaces/AMSend.nc"
static void /*WSNProject_bySpanAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMSend$sendDone(
#line 92
message_t * msg, 
...
error_t error);
# 64 "C:/cygwin/opt/tinyos-2.x/tos/interfaces/Send.nc"
static error_t /*WSNProject_bySpanAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$Send$send(
#line 56
message_t * msg, 
...
static void /*WSNProject_bySpanAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMPacket$setDestination(
#line 88
message_t * amsg, 
...
am_addr_t addr);
#line 151
static void /*WSNProject_bySpanAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMPacket$setType(
#line 147
message_t * amsg, 
...
static inline error_t /*WSNProject_bySpanAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMSend$send(am_addr_t dest, 
message_t *msg, 
uint8_t len);
...
static inline void /*WSNProject_bySpanAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$Send$sendDone(message_t *m, error_t err);
# 69 "C:/cygwin/opt/tinyos-2.x/tos/interfaces/AMSend.nc"
...
# 56 "C:/cygwin/opt/tinyos-2.x/tos/interfaces/TaskBasic.nc"
inline static error_t WSNProject_bySpanC$printStep$postTask(void ){
#line 56
  unsigned char __nesc_result;
#line 56

#line 56
  __nesc_result = SimSchedulerBasicP$TaskBasic$postTask(WSNProject_bySpanC$printStep);
#line 56
...
#line 192
{
  WSNProject_bySpanC$spans[sim_node()][WSNProject_bySpanC$indexOf(nodeid)] = 0;
}
...
#line 276
{
  uint8_t i;
#line 277
  uint8_t graySize = WSNProject_bySpanC$sizeofArray(WSNProject_bySpanC$grayNodes[sim_node()]);

  for (i = 0; i < graySize; i++) {
      if (WSNProject_bySpanC$grayNodes[sim_node()][i] == id) {
...
#line 289
{
  uint8_t i;
#line 290
  uint8_t blackSize = WSNProject_bySpanC$sizeofArray(WSNProject_bySpanC$blackNodes[sim_node()]);

  for (i = 0; i < blackSize; i++) {
      if (WSNProject_bySpanC$blackNodes[sim_node()][i] == id) {
...
# 77 "C:/cygwin/opt/tinyos-2.x/tos/interfaces/AMPacket.nc"
inline static am_addr_t WSNProject_bySpanC$AMPacket$source(message_t * amsg){
#line 77
  unsigned short __nesc_result;
#line 77
...
#line 77
# 396 "WSNProject_bySpanC.nc"
static inline message_t *WSNProject_bySpanC$Receive$receive(message_t *msg, void *payload, uint8_t len)
#line 396
{

  am_addr_t sourceNodeid = WSNProject_bySpanC$AMPacket$source(msg);
  ...
  if (len == sizeof(MDS_message )) {
      ...
      switch (__nesc_ntoh_uint8(rcvpkt->_type.data)) {
          case BLACK: 
            ...
            sim_log_debug(137U, "receiveColor", "[ %s ] *** Mote-(%d) - BLACK received from Mote-(%d). \n", sim_time_string(), TOS_NODE_ID, sourceNodeid);
          if (!WSNProject_bySpanC$isNodeBlack(sourceNodeid)) {
              WSNProject_bySpanC$deleteElement(WSNProject_bySpanC$whiteNodes[sim_node()], sourceNodeid);
              WSNProject_bySpanC$addElement(WSNProject_bySpanC$blackNodes[sim_node()], sourceNodeid);

              WSNProject_bySpanC$setZeroSpan(sourceNodeid);
              WSNProject_bySpanC$setZeroSpan(TOS_NODE_ID);

              WSNProject_bySpanC$currentState[sim_node()] = STATE_GRAY;
            }

          if (WSNProject_bySpanC$myColor[sim_node()] == WHITE) {
              WSNProject_bySpanC$myColor[sim_node()] = GRAY;
              WSNProject_bySpanC$sendBroadcastMessage(GRAY);

              sim_log_debug(138U, "printColor", "\n\n ************* Mote-(%d) - GRAY ********* \n\n", TOS_NODE_ID);
            }
          ...
          case GRAY: 
            ...
            sim_log_debug(139U, "receiveColor", "[ %s ] *** Mote-(%d) - GRAY received from Mote-(%d). \n", sim_time_string(), TOS_NODE_ID, sourceNodeid);
          if (!WSNProject_bySpanC$isNodeGray(sourceNodeid)) {
              WSNProject_bySpanC$deleteElement(WSNProject_bySpanC$whiteNodes[sim_node()], sourceNodeid);
              WSNProject_bySpanC$addElement(WSNProject_bySpanC$grayNodes[sim_node()], sourceNodeid);

              WSNProject_bySpanC$setZeroSpan(sourceNodeid);

              WSNProject_bySpanC$currentState[sim_node()] = STATE_IDLE;
            }


          if (WSNProject_bySpanC$myColor[sim_node()] == WHITE) {
              WSNProject_bySpanC$checkIfBlack();
            }
          ...
          case WHITE: 
            ...
            sim_log_debug(140U, "receiveColor", "[ %s ] *** Mote-(%d) - WHITE received from Mote-(%d). \n", sim_time_string(), TOS_NODE_ID, sourceNodeid);
          ...
          default: 
            sim_log_error(141U, "Error", "[ %s ] -- Receive.receive(): No match for the packet from Mote-(%d) --> Mote-(%d) \n", sim_time_string(), sourceNodeid, TOS_NODE_ID);
          WSNProject_bySpanC$currentState[sim_node()] = STATE_IDLE;
        }

      WSNProject_bySpanC$printStep$postTask();
    }
  else {
      sim_log_error(142U, "Error", "[ %s ] *** Mote-(%d) - Foreign packet received from Mote-(%d). \n", sim_time_string(), TOS_NODE_ID, sourceNodeid);
    }
  return msg;
}
...
# 67 "C:/cygwin/opt/tinyos-2.x/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC$Receive$receive(am_id_t arg_0x7d575a28, message_t * msg, void * payload, uint8_t len){
#line 67
  nx_struct message_t *__nesc_result;
#line 67

#line 67
  switch (arg_0x7d575a28) {
#line 67
    case 6:
#line 67
      __nesc_result = WSNProject_bySpanC$Receive$receive(msg, payload, len);
#line 67
      break;
#line 67
    default:
#line 67
      __nesc_result = TossimActiveMessageC$Receive$default$receive(arg_0x7d575a28, msg, payload, len);
#line 67
      break;
#line 67
    }
...
# 115 "C:/cygwin/opt/tinyos-2.x/tos/interfaces/Packet.nc"
inline static void * WSNProject_bySpanC$Packet$getPayload(message_t * msg, uint8_t len){
#line 115
  void *__nesc_result;
#line 115
...
#line 115
# 69 "C:/cygwin/opt/tinyos-2.x/tos/interfaces/AMSend.nc"
inline static error_t /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$AMSend$send(am_id_t arg_0x7d0447e0, am_addr_t addr, message_t * msg, uint8_t len){
#line 69
  unsigned char __nesc_result;
#line 69

#line 69
  __nesc_result = TossimActiveMessageC$AMSend$send(arg_0x7d0447e0, addr, msg, len);
#line 69
...
# 64 "C:/cygwin/opt/tinyos-2.x/tos/interfaces/Send.nc"
inline static error_t /*WSNProject_bySpanAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$Send$send(message_t * msg, uint8_t len){
#line 64
  unsigned char __nesc_result;
#line 64
...
inline static void /*WSNProject_bySpanAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMPacket$setType(message_t * amsg, am_id_t t){
#line 151
...
# 92 "C:/cygwin/opt/tinyos-2.x/tos/interfaces/AMPacket.nc"
inline static void /*WSNProject_bySpanAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMPacket$setDestination(message_t * amsg, am_addr_t addr){
#line 92
...
#line 47
{
  /*WSNProject_bySpanAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMPacket$setDestination(msg, dest);
  /*WSNProject_bySpanAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMPacket$setType(msg, 6);
  return /*WSNProject_bySpanAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$Send$send(msg, len);
}

# 69 "C:/cygwin/opt/tinyos-2.x/tos/interfaces/AMSend.nc"
inline static error_t WSNProject_bySpanC$AMSend$send(am_addr_t addr, message_t * msg, uint8_t len){
#line 69
  unsigned char __nesc_result;
#line 69

#line 69
  __nesc_result = /*WSNProject_bySpanAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMSend$send(addr, msg, len);
#line 69
...
#line 69
#line 99
inline static void TossimActiveMessageC$AMSend$sendDone(am_id_t arg_0x7d5775a0, message_t * msg, error_t error){
#line 99
  /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$AMSend$sendDone(arg_0x7d5775a0, msg, error);
#line 99
}
#line 99
...
#line 207
{
  ...
  for (i = 1; i < size; i++) {
      if (WSNProject_bySpanC$spans[sim_node()][i] >= WSNProject_bySpanC$spans[sim_node()][maxIdIndex]) {
          maxIdIndex = i;
        }
    }
...
#line 185
  for (i = 0; i < 25; i++) {
      if (WSNProject_bySpanC$spans[sim_node()][i] > 0) {
          WSNProject_bySpanC$spans[sim_node()][i]--;
        }
    }
}
...
# 67 "C:/cygwin/opt/tinyos-2.x/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC$Snoop$receive(am_id_t arg_0x7d581108, message_t * msg, void * payload, uint8_t len){
#line 67
  nx_struct message_t *__nesc_result;
#line 67

#line 67
    __nesc_result = TossimActiveMessageC$Snoop$default$receive(arg_0x7d581108, msg, payload, len);
#line 67
...
{
  uint8_t i;
  uint8_t whiteSize = WSNProject_bySpanC$sizeofArray(WSNProject_bySpanC$whiteNodes[sim_node()]);
  uint8_t graySize = WSNProject_bySpanC$sizeofArray(WSNProject_bySpanC$grayNodes[sim_node()]);
  uint8_t blackSize = WSNProject_bySpanC$sizeofArray(WSNProject_bySpanC$blackNodes[sim_node()]);
  char whites[25] = {  };
  char grays[25] = {  };
...
#line 257
      snprintf(current, sizeof current, "%d%s", WSNProject_bySpanC$whiteNodes[sim_node()][i], i + 1 < whiteSize ? ", " : "");
...
#line 263
      snprintf(current, sizeof current, "%d%s", WSNProject_bySpanC$grayNodes[sim_node()][i], i + 1 < graySize ? ", " : "");
...
#line 269
      snprintf(current, sizeof current, "%d%s", WSNProject_bySpanC$blackNodes[sim_node()][i], i + 1 < blackSize ? ", " : "");
      strcat(blacks, current);
    }

  sim_log_debug(128U, "printStep", "[ %s ] -- printStep(): me: %s, whiteNodes:[ %s ], grayNodes:[ %s ], blackNodes:[ %s ]. \n", sim_time_string(), WSNProject_bySpanC$messageTypeToString(WSNProject_bySpanC$myColor[sim_node()]), whites, grays, blacks);
}
...
# 83 "C:/cygwin/opt/tinyos-2.x/tos/interfaces/SplitControl.nc"
inline static error_t WSNProject_bySpanC$AMControl$start(void ){
#line 83
  unsigned char __nesc_result;
#line 83
...
# 41 "C:/cygwin/opt/tinyos-2.x/tos/interfaces/Random.nc"
inline static uint16_t WSNProject_bySpanC$Random$rand16(void ){
#line 41
  unsigned short __nesc_result;
#line 41
...
#line 41
# 29 "WSNProject_bySpanC.nc"
static inline uint8_t WSNProject_bySpanC$generateRandom(uint32_t upperBound)
#line 29
{
  uint16_t rnd = WSNProject_bySpanC$Random$rand16();
...
# 62 "C:/cygwin/opt/tinyos-2.x/tos/lib/timer/Timer.nc"
inline static void WSNProject_bySpanC$Timer0$startOneShot(uint32_t dt){
#line 62
  /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$startOneShot(0U, dt);
#line 62
}
#line 62
# 340 "WSNProject_bySpanC.nc"
static inline void WSNProject_bySpanC$AMControl$startDone(error_t err)
#line 340
{
  if (err == SUCCESS) {
      WSNProject_bySpanC$Timer0$startOneShot(50 + WSNProject_bySpanC$generateRandom(50));
    }
  else {
      WSNProject_bySpanC$AMControl$start();
    }
}
...
#line 92
  WSNProject_bySpanC$AMControl$startDone(error);
#line 92
}
#line 92
# 88 "C:/cygwin/opt/tinyos-2.x/tos/lib/tossim/TossimPacketModelC.nc"
...
# 349 "WSNProject_bySpanC.nc"
static inline void WSNProject_bySpanC$AMControl$stopDone(error_t err)
#line 349
{
  sim_log_debug(130U, "stopDone", "[ %s ] -- AMControl.stopDone(). \n", sim_time_string());
}
...
#line 117
  WSNProject_bySpanC$AMControl$stopDone(error);
#line 117
}
#line 117
...
# 99 "C:/cygwin/opt/tinyos-2.x/tos/interfaces/AMSend.nc"
inline static void /*WSNProject_bySpanAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMSend$sendDone(message_t * msg, error_t error){
#line 99
  WSNProject_bySpanC$AMSend$sendDone(msg, error);
#line 99
}
#line 99
...
#line 57
{
  /*WSNProject_bySpanAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMSend$sendDone(m, err);
}
...
# 89 "C:/cygwin/opt/tinyos-2.x/tos/interfaces/Send.nc"
inline static void /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$Send$sendDone(uint8_t arg_0x7d052da8, message_t * msg, error_t error){
#line 89
  switch (arg_0x7d052da8) {
#line 89
    case 0U:
#line 89
      /*WSNProject_bySpanAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$Send$sendDone(msg, error);
#line 89
      break;
#line 89
    default:
#line 89
      /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$Send$default$sendDone(arg_0x7d052da8, msg, error);
#line 89
      break;
#line 89
    }
...
#line 64
    case WSNProject_bySpanC$printStep:
#line 64
      WSNProject_bySpanC$printStep$runTask();
#line 64
      break;
#line 64
...
#line 56
# 355 "WSNProject_bySpanC.nc"
static inline void WSNProject_bySpanC$Timer0$fired(void )
#line 355
{

  sim_log_debug(131U, "Timer0fired", "[ %s ] -- onTimer0Fired: \n", sim_time_string());

  if (WSNProject_bySpanC$myColor[sim_node()] == WHITE) {
      sim_log_debug(132U, "Timer0fired", "[ %s ] -- WHITE. \n", sim_time_string());
...
# 72 "C:/cygwin/opt/tinyos-2.x/tos/lib/timer/Timer.nc"
inline static void /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$fired(uint8_t arg_0x7d218a20){
#line 72
  switch (arg_0x7d218a20) {
#line 72
    case 0U:
#line 72
      WSNProject_bySpanC$Timer0$fired();
#line 72
      break;
#line 72
    default:
#line 72
      /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$default$fired(arg_0x7d218a20);
#line 72
      break;
#line 72
    }
...
#line 95
  ...
  sim_log_debug(123U, "printArray", "*** Mote-(%d) - %s: [ ", TOS_NODE_ID, arrName);
  for (i = 0; i < size; i++) {
      printf("%d; ", arr[i]);
    }
  printf("] \n \n");
...
#line 84
{
  uint8_t i;
#line 85
  uint8_t size = WSNProject_bySpanC$sizeofArray(arr);
...
#line 304
{
  ...
  uint8_t i;
  uint8_t size = WSNProject_bySpanC$sizeofArray(topology20[WSNProject_bySpanC$indexOf(TOS_NODE_ID)]);

  WSNProject_bySpanC$spans[sim_node()][WSNProject_bySpanC$indexOf(TOS_NODE_ID)] = size;

  for (i = 0; i < size; i++) {
      WSNProject_bySpanC$neighborNodes[sim_node()][i] = topology20[WSNProject_bySpanC$indexOf(TOS_NODE_ID)][i];
    }

  WSNProject_bySpanC$insertionSort(WSNProject_bySpanC$neighborNodes[sim_node()]);

  WSNProject_bySpanC$spans[sim_node()][WSNProject_bySpanC$indexOf(TOS_NODE_ID)] = size;

  for (i = 0; i < size; i++) {
      WSNProject_bySpanC$whiteNodes[sim_node()][i] = WSNProject_bySpanC$neighborNodes[sim_node()][i];

      WSNProject_bySpanC$spans[sim_node()][WSNProject_bySpanC$indexOf(WSNProject_bySpanC$neighborNodes[sim_node()][i])] = WSNProject_bySpanC$sizeofArray(topology20[WSNProject_bySpanC$indexOf(WSNProject_bySpanC$neighborNodes[sim_node()][i])]);
    }


  WSNProject_bySpanC$myColor[sim_node()] = WHITE;


  WSNProject_bySpanC$printArray("sorted neighborNodes/whiteNodes", WSNProject_bySpanC$whiteNodes[sim_node()]);
  WSNProject_bySpanC$printFullArray("spans", WSNProject_bySpanC$spans[sim_node()]);

  sim_log_debug(129U, "booted", "[ %s ] -- Booted.\n", sim_time_string());
...
#line 49
  WSNProject_bySpanC$Boot$booted();
#line 49
}
#line 49
...
#line 146
    {
      sim_log_error(124U, "Error", "[ %s ] -- deleteElement(): Array does not contain %d value. \n", sim_time_string(), val);
    }
}
...
#line 171
          {
            sim_log_error(125U, "Error", "[ %s ] -- addElement(): Not possible to add element %d due to case 1.!!! \n", sim_time_string(), val);
          }
        }
    }
  else 
#line 174
    {
      sim_log_error(126U, "Error", "[ %s ] -- addElement(): Not possible to add element %d due to case 2.!!! \n", sim_time_string(), val);
    }
}
...
#line 65
{
  ...
  MDS_message *btrpkt = (MDS_message *)WSNProject_bySpanC$Packet$getPayload(&WSNProject_bySpanC$pkt[sim_node()], sizeof(MDS_message ));
  ...
  if (WSNProject_bySpanC$AMSend$send(AM_BROADCAST_ADDR, &WSNProject_bySpanC$pkt[sim_node()], sizeof(MDS_message )) == SUCCESS) {

      sim_log_debug(120U, "sendBroadcastMessage", "[ %s ] -- sendBroadcastMessage(): %s packet from Mote-(%d) --> All\n", sim_time_string(), WSNProject_bySpanC$messageTypeToString(type), TOS_NODE_ID);
    }
  else 
#line 78
    {
...
# 369 "WSNProject_bySpanC.nc"
static void WSNProject_bySpanC$AMSend$sendDone(message_t *msg, error_t err)
#line 369
{

  MDS_message *releasedMsg = (MDS_message *)WSNProject_bySpanC$Packet$getPayload(msg, sizeof(MDS_message ));

  switch (__nesc_ntoh_uint8(releasedMsg->_type.data)) {
      case GRAY: 
        sim_log_debug(133U, "sendDone", "[ %s ] -- AMSend.sendDone(): GRAY message from Mote-(%d) --> Mote-(ALL) was sent. \n", sim_time_string(), TOS_NODE_ID);

      break;

      case BLACK: 
        sim_log_debug(134U, "sendDone", "[ %s ] -- AMSend.sendDone(): BLACK message from from Mote-(%d) --> Mote-(ALL) was sent. \n", sim_time_string(), TOS_NODE_ID);

      break;

      case WHITE: 
        sim_log_debug(135U, "sendDone", "[ %s ] -- AMSend.sendDone(): WHITE message from from Mote-(%d) --> Mote-(ALL) was sent. \n", sim_time_string(), TOS_NODE_ID);

      break;
      default: 
        sim_log_error(136U, "Error", "[ %s ] -- AMSend.sendDone(): No match for the packet from Mote-(%d) --> Mote-(%d) \n", sim_time_string(), TOS_NODE_ID);
    }
}
...
#line 221
{
  ...
  if (WSNProject_bySpanC$myColor[sim_node()] == WHITE) {
      WSNProject_bySpanC$currentState[sim_node()] = STATE_CHECK;
      maxSpanIndex = WSNProject_bySpanC$findIndexOfMaximumSpan(WSNProject_bySpanC$whiteNodes[sim_node()]);

      if (maxSpanIndex == WSNProject_bySpanC$indexOf(TOS_NODE_ID)) {

          WSNProject_bySpanC$myColor[sim_node()] = BLACK;

          WSNProject_bySpanC$sendBroadcastMessage(BLACK);

          WSNProject_bySpanC$currentState[sim_node()] = STATE_BLACK;

          sim_log_debug(127U, "printColor", "\n\n ************* Mote-(%d) - BLACK ********* \n\n", TOS_NODE_ID);

          WSNProject_bySpanC$decreaseSpans();
        }
      else 
#line 239
        {
                               ...
                               uintptr_t* addr, size_t* size)
{
  ...
  if (!strcmp(varname, "WSNProject_bySpanC$neighborNodes"))
  {
    *addr = (uintptr_t)&WSNProject_bySpanC$neighborNodes[__nesc_mote];
    *size = sizeof(WSNProject_bySpanC$neighborNodes[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "WSNProject_bySpanC$whiteNodes"))
  {
    *addr = (uintptr_t)&WSNProject_bySpanC$whiteNodes[__nesc_mote];
    *size = sizeof(WSNProject_bySpanC$whiteNodes[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "WSNProject_bySpanC$grayNodes"))
  {
    *addr = (uintptr_t)&WSNProject_bySpanC$grayNodes[__nesc_mote];
    *size = sizeof(WSNProject_bySpanC$grayNodes[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "WSNProject_bySpanC$blackNodes"))
  {
    *addr = (uintptr_t)&WSNProject_bySpanC$blackNodes[__nesc_mote];
    *size = sizeof(WSNProject_bySpanC$blackNodes[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "WSNProject_bySpanC$spans"))
  {
    *addr = (uintptr_t)&WSNProject_bySpanC$spans[__nesc_mote];
    *size = sizeof(WSNProject_bySpanC$spans[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "WSNProject_bySpanC$currentState"))
  {
    *addr = (uintptr_t)&WSNProject_bySpanC$currentState[__nesc_mote];
    *size = sizeof(WSNProject_bySpanC$currentState[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "WSNProject_bySpanC$myColor"))
  {
    *addr = (uintptr_t)&WSNProject_bySpanC$myColor[__nesc_mote];
    *size = sizeof(WSNProject_bySpanC$myColor[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "WSNProject_bySpanC$pkt"))
  {
    *addr = (uintptr_t)&WSNProject_bySpanC$pkt[__nesc_mote];
    *size = sizeof(WSNProject_bySpanC$pkt[__nesc_mote]);
    return 0;
  }
...
static void __nesc_nido_initialise(int __nesc_mote)
{
  ...
  /* Module WSNProject_bySpanC */
  memcpy((void *)&WSNProject_bySpanC$neighborNodes[__nesc_mote], (void *)&(unsigned short [25]){  }, sizeof WSNProject_bySpanC$neighborNodes[__nesc_mote]);
  memcpy((void *)&WSNProject_bySpanC$whiteNodes[__nesc_mote], (void *)&(unsigned short [25]){  }, sizeof WSNProject_bySpanC$whiteNodes[__nesc_mote]);
  memcpy((void *)&WSNProject_bySpanC$grayNodes[__nesc_mote], (void *)&(unsigned short [25]){  }, sizeof WSNProject_bySpanC$grayNodes[__nesc_mote]);
  memcpy((void *)&WSNProject_bySpanC$blackNodes[__nesc_mote], (void *)&(unsigned short [25]){  }, sizeof WSNProject_bySpanC$blackNodes[__nesc_mote]);
  memcpy((void *)&WSNProject_bySpanC$spans[__nesc_mote], (void *)&(unsigned short [25]){  }, sizeof WSNProject_bySpanC$spans[__nesc_mote]);
  memset((void *)&WSNProject_bySpanC$currentState[__nesc_mote], 0, sizeof WSNProject_bySpanC$currentState[__nesc_mote]);
  WSNProject_bySpanC$myColor[__nesc_mote] = WHITE;
  memset((void *)&WSNProject_bySpanC$pkt[__nesc_mote], 0, sizeof WSNProject_bySpanC$pkt[__nesc_mote]);
