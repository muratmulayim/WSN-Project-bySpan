...
#line 304
{
  ...
  uint8_t i;
  uint8_t size = WSNProject_bySpanC$sizeofArray(topology9[WSNProject_bySpanC$indexOf(TOS_NODE_ID)]);

  WSNProject_bySpanC$spans[sim_node()][WSNProject_bySpanC$indexOf(TOS_NODE_ID)] = size;

  for (i = 0; i < size; i++) {
      WSNProject_bySpanC$neighborNodes[sim_node()][i] = topology9[WSNProject_bySpanC$indexOf(TOS_NODE_ID)][i];
    }
  ...
  for (i = 0; i < size; i++) {
      ...
      WSNProject_bySpanC$spans[sim_node()][WSNProject_bySpanC$indexOf(WSNProject_bySpanC$neighborNodes[sim_node()][i])] = WSNProject_bySpanC$sizeofArray(topology9[WSNProject_bySpanC$indexOf(WSNProject_bySpanC$neighborNodes[sim_node()][i])]);
    }
